...
def generate_launch_description():
    ...
    default_model = os.path.join(q1_pkg, 'models', 'braitenberg', 'bug_scene.xml')
    sim_config    = os.path.join(q1_pkg, 'config', 'sim_params.yaml')
